...
sprite_image = pygame.transform.scale(pygame.image.load("bg.jpg"),
                                          (80,60))
...
# Create sprites
sprite1 = Sprite(pygame.Color('green'), 40, 50)
...
sprite2 = Sprite(pygame.Color(' light blue'), 10,30)
...
while running: 
    ...
    # Display win message
    if won:
        win_text = font.render("You win!", True, pygame.Color('mageta'))
